...
let mydropdown = document.getElementById('nationalityInput');
mydropdown.length = 0;
...
nationality.forEach((nn)=>{
    myOption = document.createElement('option');
    myOption.text = `${nn.Nationality}`
    myOption.value = nn.CountryCode;
    mydropdown.add(myOption);
})
